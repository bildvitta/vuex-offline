(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxdb/plugins/core'), require('rxdb/plugins/validate'), require('rxdb/plugins/query-builder'), require('rxdb/plugins/migration'), require('rxdb/plugins/replication'), require('rxdb/plugins/leader-election'), require('rxdb/plugins/update'), require('rxdb/dist/es/rx-error.js')) :
  typeof define === 'function' && define.amd ? define(['exports', 'rxdb/plugins/core', 'rxdb/plugins/validate', 'rxdb/plugins/query-builder', 'rxdb/plugins/migration', 'rxdb/plugins/replication', 'rxdb/plugins/leader-election', 'rxdb/plugins/update', 'rxdb/dist/es/rx-error.js'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.VuexOffline = {}, global.core, global.validate, global.queryBuilder, global.migration, global.replication, global.leaderElection, global.update$1, global.rxError_js));
}(this, (function (exports, core, validate, queryBuilder, migration, replication, leaderElection, update$1, rxError_js) { 'use strict';
  ...
  function formatError (error) {
    ...
    if (!(error instanceof rxError_js.RxError)) {
      throw error;
    }
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  this.addDatabasePlugin(validate.RxDBValidatePlugin, queryBuilder.RxDBQueryBuilderPlugin, migration.RxDBMigrationPlugin, replication.RxDBReplicationPlugin, leaderElection.RxDBLeaderElectionPlugin, update$1.RxDBUpdatePlugin, require('pouchdb-adapter-idb'));
                  ...
                  _context.next = 4;
                  return core.createRxDatabase(_objectSpread2({
                    adapter: 'idb'
